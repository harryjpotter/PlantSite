 ...
 <div class="container">
    <form id="signup" runat="server">
        <h1 > Sign Up </h1> <br/>
            ...
            <div class="form-group">
            <input class="form-control" placeholder="Enter username" type="text" name="Username" id="Username"/> <br/> <br/> Password
            <br/>
            </div>
            <div class="form-group">
        ...
        <input type="submit" class="btn btn-primary" id="notsubmit" onclick="verify()" /> <br/>
